    ...
    fn visit_ty(&mut self, ty: I::Ty) -> Self::Result {
        ...
        let result = match ty.kind() {
            ...
            ty::Field(container, field_path) => {
                field_path.walk(self.infcx.cx(), container, |base, _, _| {
                ...
                // TODO(field_projections): should we return `OrphanCheckEarlyExit::LocalTy` here
                // pointing to the first local type we found (or some other one?)
