...
pub use self::sty::{
    ...
    CoroutineArgsExt, EarlyBinder, FieldPathSegment, FnSig, InlineConstArgs, InlineConstArgsParts,
    ParamConst, ParamTy, PolyFnSig, TyKind, TypeAndMut, TypingMode, UpvarArgs,
};
